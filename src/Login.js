        ...
        {activeTab === 'login' && (
          <div className={`tab-pane fade ${activeTab === 'login' ? 'show active' : ''}`}>
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <button type="submit" className="btn btn-primary" onClick={addTologin}>Submit</button>
            </form>
          </div>
        )}
        ...
        {activeTab === 'register' && (
          <div className={`tab-pane fade ${activeTab === 'register' ? 'show active' : ''}`}>
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <button type="submit" className="btn btn-primary"onClick={addToRegister}>Submit</button>
            </form>
          </div>
        )}
      </div>
